...
export default function ShortsTrending({
  ...
  return (
    <section className="w-full bg-gradient-to-br from-blue-50 via-white to-blue-50/50 py-10 md:py-14 lg:py-16">
      {/* Section Header - Clean, no icon */}
      ...
      >
        {canScrollLeft && (
          <div className="hidden lg:block absolute left-0 top-0 bottom-0 bg-gradient-to-r from-blue-50/90 via-blue-50/60 to-transparent z-10 pointer-events-none lg:w-[120px]" />
        )}

        <div className="hidden lg:block absolute right-0 top-0 bottom-0 bg-gradient-to-l from-blue-50/90 via-blue-50/60 to-transparent z-10 pointer-events-none lg:w-[120px]" />
